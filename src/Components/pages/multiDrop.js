            ...
            <div className="text-center">
              ...
              <div className="mt-4">
                <div>
                  ...
                  <h3>
                    {new Date(drop.salePeriods.presale).toDateString()},{' '}
                    {new Date(drop.salePeriods.presale).toTimeString()}
                  </h3>
                </div>
                ...
                <div>
                  ...
                  <h3>
                    {new Date(drop.salePeriods.public).toDateString()},{' '}
                    {new Date(drop.salePeriods.public).toTimeString()}
                  </h3>
                </div>
              </div>
            </div>
