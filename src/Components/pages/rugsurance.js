        ...
        <div className="row">
          <div className="col-lg-12">
            <p className="text-center">
              Slothty NFTs can only be refunded to the wallet they were originally minted from. Any unselectable NFTs
                          ...
                          {nft.isEligible ? (
                            <div className="nft__item_action">
                              <span style={{ cursor: 'pointer' }} onClick={() => selectNft(nft)}>
                                {selectedNfts.includes(nft.id) ? <>Unselect</> : <>Select for Burn</>}
                              </span>
                            </div>
                          ) : (
