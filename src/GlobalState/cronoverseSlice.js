...
import config from '../Assets/networks/rpc_config_testnet.json';
// import Cronies from '../Contracts/CronosToken.json';
import cronoverseContract from '../Contracts/Cronoverse.json'

const readProvider = new ethers.providers.JsonRpcProvider('https://cronos-testnet-3.crypto.org:8545');
